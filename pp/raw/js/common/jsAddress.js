...
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
	...
	{
		var select2 = document.getElementById("select2-"+cmb.getAttribute("id")+"-container");
		...
		if(select2) {
			$(select2).text(cmb.options[cmb.selectedIndex].value);
			$(select2).attr("title",cmb.options[cmb.selectedIndex].value);
		}
	}
