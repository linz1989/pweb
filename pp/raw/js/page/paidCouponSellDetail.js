require(["css!../../compressed/css/page/paidCouponDataStatistics.css?"+$$.rootVm.currTime,"daterangepicker","!domReady"],function(){
    ...
    $$.currPath.html("数据统计 >> <a href='#!/paidCouponDataStatistics'>点钟券</a> >> 点钟券购买详情");
    ...
    function queryData(page,start,end){
        ...
        $.ajax({
            url : "club/datastatistics/paidcoupon/paid",
            type : "post",
            data : {
                page : page ,
                pageSize : pageSize,
                ...
                couponStatus : vm.currCouponStatus,
